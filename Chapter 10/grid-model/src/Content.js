...
export async function getSubChapterNames(chapterNumber) {
  ...
  const subChapterNames = await fetch(generateUrl(subChapterQuery)).then(
    (res) => res.json()
  );
